...
(function () {
    ...
    window.GMT_LOCALES["fr"] = {
        ...
        "card_reminder_schedule": "Horaires de rappels",
        "reminders_intro": "Créneaux de rappels d’événements par guilde (UTC). Les rappels partent avant chaque créneau aux décalages configurés, sur votre webhook Discord et vers les appareils abonnés.",
        "day_mon": "Lundi",
        "day_tue": "Mardi",
        "day_wed": "Mercredi",
        "day_thu": "Jeudi",
        ...
        "day_sat": "Samedi",
        "day_sun": "Dimanche",
        "rem_kind_gvg_war_prism": "GvG · War Prism",
        "rem_kind_gvg_war_fortress": "GvG · War Fortress",
        "rem_kind_svs_garrison": "SvS · Garnison",
        "rem_kind_svs_battle": "SvS · Bataille",
        "rem_kind_calamity_round": "Round Calamity",
        "rem_kind_custom": "Personnalisé",
        "reminders_not_ready": "Activé avec la mise à jour multi-tenant",
        "reminders_not_ready_hint": "Les horaires de rappels personnalisés seront disponibles une fois votre guilde migrée. D’ici là, l’horaire intégré est utilisé.",
        "reminders_load_template": "Charger le modèle par défaut",
        "reminders_add": "Ajouter un créneau",
        "reminders_empty": "Aucun créneau de rappel",
        "reminders_requires": "requiert",
        "reminders_disabled": "désactivé",
        "reminders_offsets": "décalages",
        "reminders_delete_title": "Supprimer le créneau",
        "reminders_delete_body": "Supprimer ce créneau de rappel ? Action irréversible.",
        "reminders_edit_title": "Modifier le créneau",
        "reminders_kind": "Type",
        "reminders_label": "Libellé",
        "reminders_day": "Jour (UTC)",
        "reminders_time": "Heure (UTC)",
        "reminders_offsets_label": "Décalages de rappel (minutes avant, séparés par des virgules ; 0 = au départ)",
