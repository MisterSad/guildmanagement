...
(function () {
    ...
    window.GMT_LOCALES["en"] = {
        ...
        "card_reminder_schedule": "Reminder schedule",
        "reminders_intro": "Per-guild event reminder slots (UTC). Reminders fire before each slot at the configured minute offsets, on your Discord webhook and to opted-in devices.",
        "day_mon": "Monday",
        "day_tue": "Tuesday",
        "day_wed": "Wednesday",
        "day_thu": "Thursday",
        ...
        "rem_kind_svs_garrison": "SvS · Garrison",
        "rem_kind_svs_battle": "SvS · Battle",
        "rem_kind_calamity_round": "Calamity round",
        "rem_kind_custom": "Custom",
        "reminders_not_ready": "Activates with the multi-tenant update",
        "reminders_not_ready_hint": "Custom reminder schedules become available once your guild is migrated. Until then, the built-in schedule is used.",
        "reminders_load_template": "Load default template",
        "reminders_add": "Add slot",
        "reminders_empty": "No reminder slots yet",
        "reminders_requires": "requires",
        "reminders_disabled": "disabled",
        "reminders_offsets": "offsets",
        "reminders_delete_title": "Delete reminder slot",
        "reminders_delete_body": "Remove this reminder slot? This cannot be undone.",
        "reminders_edit_title": "Edit reminder slot",
        "reminders_kind": "Type",
        "reminders_label": "Label",
        "reminders_day": "Day (UTC)",
        "reminders_time": "Time (UTC)",
        "reminders_offsets_label": "Reminder offsets (minutes before, comma-separated; 0 = at start)",
