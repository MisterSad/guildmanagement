...
- **More badge tiers**: the badge catalog now has 41 badges — a brand-new **Glory** track (1K to 1M weekly Glory, driven by the player's best week ever), Seniority with fine intermediate steps capped at 2 years (1/2/3/6/9 months, 1/18/24 months), Power in fine steps capped at 300M (10M to 300M), and Participation from 10 to 1500 events attended.
