...
- **Renamed Settings Tab to Draft**: Updated the super admin cross-guild ranking page and navigation menu item from **"Settings"** to **"Draft"** across `i18n.js`, `index.html`, and `shell.js`.
