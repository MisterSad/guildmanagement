...
(function () {
    ...
    function buildGvgDailyTaskEmbed(dayNumber, roleMention) {
        roleMention = roleMention || "@everyone";
        var day = GVG_DAILY_TASKS[dayNumber] || GVG_DAILY_TASKS[1];

        var fields = day.categories.map(function (cat) {
            var lines = cat.tasks.map(function (t) { return "• " + t.label + ": **`" + t.points + "`**"; }).join("\n");
            return {
        ...
        var content = "📢 **GvG Day " + day.dayNumber + " Tasks are Live!** (" + day.dayName + " · 00:01 UTC) " + roleMention;
    ...
    var gmExports = {
        ...
        gvgTasks: {
            GVG_DAILY_TASKS: GVG_DAILY_TASKS,
            buildGvgDailyTaskEmbed: buildGvgDailyTaskEmbed
        }
    };

    window.GM = Object.assign(window.GM || {}, gmExports);
    window.GM_GVG_TASKS = {
        GVG_DAILY_TASKS: GVG_DAILY_TASKS,
        buildGvgDailyTaskEmbed: buildGvgDailyTaskEmbed
    };
