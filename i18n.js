...
(function () {
    ...
    var TRANSLATIONS = {
        en: {
            ...
            gm_sub_widget_error:   'Could not open the payment widget.',
            gm_sub_load_error:     'Could not load the subscription page',
            gm_sub_retry:          'Retry',
            gm_sub_denied:         'Admins only',
            gm_sub_methods:        'Accepted payments: Card, Apple Pay, Google Pay and Revolut Pay.',
            gm_sub_security:       'Payments are processed and secured by Revolut. The site administrator never has access to your bank details.',
