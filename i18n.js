...
(function () {
    ...
    var TRANSLATIONS = {
        en: {
            ...
            confirm_delete_guild_title:     'Delete guild',
            confirm_delete_guild_body:      'Delete guild',
            confirm_delete_guild_body2:     '? This will permanently erase all members, events, scores, and data for this guild. This action is irreversible.',
            ...
            sf_add_s1:             'Add to Squad One',
            sf_add_s2:             'Add to Squad Two',
            sf_remove_avail:       'Remove availability',
            sf_avail_bulk:         '{n} players marked available for {squad}.',
            ...
            sf_sort_rate:          'Rate',
            sf_sort_power:         'Power',
            sf_avg_rate:           'Avg rate',
            sf_all_present:        'All present',
            sf_all_absent:         'All absent',
            sf_saved:              'Saved',
            sf_share_discord:      'Share on Discord',
            sf_share_discord_sent: 'Composition sent to Discord.',
            sf_share_discord_failed: 'Failed to send to Discord. Check the Shadowfront webhook in the Discord settings.',
            ...
            gm_sub_subscribe:      'Subscribe',
            gm_sub_one_time:       'one-time payment',
            gm_sub_processing:     'Processing payment…',
            gm_sub_success:        'Subscription activated - thank you!',
            gm_sub_waiting:        'Payment received - activation in progress…',
            gm_sub_payment_failed: 'Payment failed, please try again.',
            gm_sub_not_configured: 'Payments are not configured yet.',
            gm_sub_widget_error:   'Could not start the payment.',
            gm_sub_cancelled:      'Payment cancelled.',
            gm_sub_redirecting:    'Redirecting...',
