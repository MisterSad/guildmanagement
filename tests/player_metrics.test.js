...
describe('Tactical Military Metrics & Calculations', () => {
    ...
    it('prioritizes components in exact order (Fleet > Flagship > Crew > Tech > Champs > Glory)', () => {
        ...
        expect(window.GM.calculateRallyScore(moreTech) - scoreBase).toBe(6000000);
