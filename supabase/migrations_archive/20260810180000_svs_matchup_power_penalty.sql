-- 20260810180000_svs_matchup_power_penalty.sql
-- Applies power penalties to Dangerosity Scoring:
-- Power < 60M = big penalty (0.3x multiplier)
-- Power 60M..90M = moderate penalty (0.65x multiplier)
-- Power > 90M = normal dangerosity (1.0x multiplier)
