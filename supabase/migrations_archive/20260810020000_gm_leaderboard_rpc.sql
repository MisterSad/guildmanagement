-- 20260810020000_gm_leaderboard_rpc.sql
-- Server-side deterministic leaderboard calculation RPC.
-- Replaces client-side JS score aggregation with a single SECURITY DEFINER SQL function.
