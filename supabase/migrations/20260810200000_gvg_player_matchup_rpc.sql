-- 20260810200000_gvg_player_matchup_rpc.sql
-- RPC for SuperAdmin GvG Player Roster Matchup & Dangerosity Scoring.

drop function if exists public.gm_gvg_player_matchup();
...
revoke all on function public.gm_gvg_player_matchup() from public, anon, authenticated;
grant execute on function public.gm_gvg_player_matchup() to authenticated;
