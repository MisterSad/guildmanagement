-- 20260810110000_fix_push_subscriptions_unique_endpoint.sql
-- 1. Ensure unique index on push_subscriptions(endpoint) so ON CONFLICT (endpoint) always matches
CREATE UNIQUE INDEX IF NOT EXISTS push_subscriptions_endpoint_key
  ON public.push_subscriptions (endpoint);

-- 2. Update save_push_subscription RPC
