...
(function () {
    ...
    function render(container) {
        ...
        // Barre d'outils et sélecteurs de Guildes A vs B (Grid 1fr 1fr aligné avec gap:1.25rem)
        var headerHtml =
            '<div class="gm-card glass-card gm-section" style="padding:1.5rem; margin-bottom:1.5rem;">' +
                ...
                '<!-- Matchup Guild Selectors: Grille 1fr 1fr alignée avec les tuiles de résumé et les tableaux -->' +
